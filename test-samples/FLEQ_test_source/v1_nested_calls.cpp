...
QExpr U3(qbit &q, double theta, double phi, double gamma){
...
QExpr U3On5(double theta, double phi, double gamma){
...
QExpr measHOn5(double coeff[], double& E, QExpr prep ){
