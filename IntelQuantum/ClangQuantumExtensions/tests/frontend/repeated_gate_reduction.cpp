...
// CHECK-NEXT:    call void @_Z1XRt(ptr noundef nonnull align 2 dereferenceable(2) [[ARRAYIDX4]])
// CHECK-NEXT:    [[ARRAYIDX5:%.*]] = getelementptr inbounds [2 x i16], ptr [[Q]], i64 0, i64 0
// CHECK-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds [2 x i16], ptr [[Q]], i64 0, i64 1
// CHECK-NEXT:    call void @_Z4CNOTRtS_(ptr noundef nonnull align 2 dereferenceable(2) [[ARRAYIDX5]], ptr noundef nonnull align 2 dereferenceable(2) [[ARRAYIDX6]])
...
int main() {
  ...
  // expected reduction from optimizer:
  // H(q[0]);
  // CNOT(q[0],q[1]);
  // __quantum_measz(q[0], 0);
}
